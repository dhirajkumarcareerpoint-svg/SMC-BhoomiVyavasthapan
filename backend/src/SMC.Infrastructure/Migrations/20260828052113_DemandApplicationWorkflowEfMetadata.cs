...
{
    /// <inheritdoc />
    public partial class DemandApplicationWorkflowEfMetadata : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OsPaymentNotificationSentAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DemandApplicationWorkflows_DemandApplications_DemandApplicationId",
                        column: x => x.DemandApplicationId,
                        principalTable: "DemandApplications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "IX_DemandApplicationWorkflows_DemandApplicationId",
                table: "DemandApplicationWorkflows",
                column: "DemandApplicationId",
                unique: true);
