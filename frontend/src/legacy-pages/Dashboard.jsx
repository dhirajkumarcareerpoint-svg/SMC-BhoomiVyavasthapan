...
export default function Dashboard() {
  ...
  if (!data) return (
    <div>
      <div className="page-header"><div><div className="page-title">डॅशबोर्ड</div><div className="page-subtitle">भूमी व मालमत्ता विभाग - एकूण सारांश</div></div></div>
      <div className="stat-grid" aria-busy="true">{Array.from({ length: 9 }, (_, index) => <div className="card dashboard-skeleton" key={index} />)}</div>
      <div className="dashboard-loading">माहिती अद्ययावत करत आहे...</div>
    </div>
  )
